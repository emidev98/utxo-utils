...
const SettingsPage: React.FC = () => {
  ...
  const { getStoredData, updateMempoolAPIUrl, resetMempoolData, queryTxsByAddr } = useMempoolApi();
    ...
    <div className="SettingsPage">
      <IonCard>
        ...
        <IonCardContent className='SettingsCardContent'>
          ...
          <div className='AlignFooterEnd'><IonButton onClick={onSyncFromAPI}>Sync</IonButton></div>
        </IonCardContent>
      </IonCard>
      ...
      <IonCard>
        ...
        <IonCardContent className='SettingsCardContent'>
          ...
          <div className='AlignFooterEnd'><IonButton color="danger" onClick={onResetData}>Reset data</IonButton></div>
        </IonCardContent>
      </IonCard>

      <AppToast isOpen={toast.isOpen}
        onClick={() => setToastData({ isOpen: false, message: "", color: "" })}
        onDidDismiss={() => setToastData({ isOpen: false, message: "", color: "" })}
